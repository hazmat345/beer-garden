...
def _setup_tornado_app() -> Application:
    ...
    published_url_specs = [
        ...
        (rf"{prefix}api/v1/instances/(\w+)/?", v1.instance.InstanceIdAPI),
        (rf"{prefix}api/v1/instances/(\w+)/logs/?", v1.instance.IdLogAPI),
        (rf"{prefix}api/v1/instances/(\w+)/queues/?", v1.instance.IdQueuesAPI),
        ...
        (rf"{prefix}api/v2/systems/(\w+)/instances/(\w+)/?", v1.instance.InstanceAPI),
        (rf"{prefix}api/v2/systems/(\w+)/instances/(\w+)/logs/?", v1.instance.LogAPI),
        (
            rf"{prefix}api/v2/systems/(\w+)/instances/(\w+)/queues/?",
            v1.instance.QueuesAPI,
        ),
